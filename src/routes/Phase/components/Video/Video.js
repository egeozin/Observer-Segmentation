...
export default class Video extends Component {
	...
	render () {
		...
		return <ReactPlayer ref={this.ref} config={{youtube: {playerVars: {rel: 0, showinfo: 0, controls:0, showinfo:0}}}} className='playerWrapper' url={videoUrl} progressFrequency={10} playing={this.props.play} onStart={this.props.whenStart} onProgress={this.props.onVideoProgress} onReady={this.durationUpdate} onPlay={this.props.onVideoReady} onEnded={this.props.whenEnd} onPause={this.props.whenPause}/>
